    ...
    settings = {
        biomes = {
            everness_coral_forest = {
                ...
                y_min = tonumber(core.settings:get('everness_coral_forest_y_min')) or 4,
            },
            everness_coral_forest_dunes = {
                enabled = core.settings:get_bool('everness_coral_forest_dunes', false),
            ...
            everness_coral_forest_ocean = {
                ...
                y_max = tonumber(core.settings:get('everness_coral_forest_ocean_y_max')) or -2,
            ...
            everness_coral_forest_deep_ocean = {
                ...
                y_min = tonumber(core.settings:get('everness_coral_forest_deep_ocean_y_min')) or -36,
            },
            everness_coral_forest_under = {
                enabled = core.settings:get_bool('everness_coral_forest_under', true),
                y_max = tonumber(core.settings:get('everness_coral_forest_under_y_max')) or 0,
            ...
            everness_frosted_icesheet = {
                ...
                y_min = tonumber(core.settings:get('everness_frosted_icesheet_y_min')) or -9,
            },
            everness_frosted_icesheet_ocean = {
                ...
                y_min = tonumber(core.settings:get('everness_frosted_icesheet_ocean_y_min')) or -36,
            },
            everness_frosted_icesheet_under = {
                enabled = core.settings:get_bool('everness_frosted_icesheet_under', true),
                y_max = tonumber(core.settings:get('everness_frosted_icesheet_under_y_max')) or 0,
            ...
            everness_cursed_lands = {
                ...
                y_min = tonumber(core.settings:get('everness_cursed_lands_y_min')) or 4,
            },
            everness_cursed_lands_dunes = {
                enabled = core.settings:get_bool('everness_cursed_lands_dunes', false),
            ...
            everness_cursed_lands_deep_ocean = {
                ...
                y_min = tonumber(core.settings:get('everness_cursed_lands_ocean_y_min')) or -36,
            },
            everness_cursed_lands_under = {
                enabled = core.settings:get_bool('everness_cursed_lands_under', true),
                y_max = tonumber(core.settings:get('everness_cursed_lands_under_y_max')) or 0,
            ...
            everness_crystal_forest = {
                ...
                y_min = tonumber(core.settings:get('everness_crystal_forest_y_min')) or 4,
            },
            everness_crystal_forest_dunes = {
                enabled = core.settings:get_bool('everness_crystal_forest_dunes', false),
            ...
            everness_crystal_forest_shore = {
                ...
                y_max = tonumber(core.settings:get('everness_crystal_forest_shore_y_max')) or 3,
            ...
            everness_crystal_forest_deep_ocean = {
                ...
                y_min = tonumber(core.settings:get('everness_crystal_forest_deep_ocean_y_min')) or -36,
            },
            everness_crystal_forest_under = {
                enabled = core.settings:get_bool('everness_crystal_forest_under', true),
                y_max = tonumber(core.settings:get('everness_crystal_forest_under_y_max')) or 0,
            ...
            everness_bamboo_forest = {
                ...
                y_min = tonumber(core.settings:get('everness_bamboo_forest_y_min')) or 4,
            },
            everness_bamboo_forest_under = {
                enabled = core.settings:get_bool('everness_bamboo_forest_under', true),
                y_max = tonumber(core.settings:get('everness_bamboo_forest_under_y_max')) or 0,
            ...
            everness_forsaken_desert_ocean = {
                ...
                y_max = tonumber(core.settings:get('everness_forsaken_desert_ocean_y_max')) or -2,
                y_min = tonumber(core.settings:get('everness_forsaken_desert_ocean_y_min')) or -36,
            },
            everness_forsaken_desert_under = {
                enabled = core.settings:get_bool('everness_forsaken_desert_under', true),
                y_max = tonumber(core.settings:get('everness_forsaken_desert_under_y_max')) or 0,
                y_min = tonumber(core.settings:get('everness_forsaken_desert_under_y_min')) or -31000,
            },
            everness_baobab_savanna = {
                enabled = core.settings:get_bool('everness_baobab_savanna', false),
                y_max = tonumber(core.settings:get('everness_baobab_savanna_y_max')) or 31000,
                y_min = tonumber(core.settings:get('everness_baobab_savanna_y_min')) or 4,
            },
            everness_forsaken_tundra = {
                ...
                y_min = tonumber(core.settings:get('everness_forsaken_tundra_y_min')) or 4,
            },
            ...
            everness_forsaken_tundra_ocean = {
                ...
                y_max = tonumber(core.settings:get('everness_forsaken_tundra_ocean_y_max')) or -2,
                y_min = tonumber(core.settings:get('everness_forsaken_tundra_ocean_y_min')) or -36,
            },
            everness_forsaken_tundra_under = {
                enabled = core.settings:get_bool('everness_forsaken_tundra_under', true),
                y_max = tonumber(core.settings:get('everness_forsaken_tundra_under_y_max')) or 0,
            ...
            everness_mineral_waters = {
                ...
                y_min = tonumber(core.settings:get('everness_mineral_waters_y_min')) or 4,
            },
            everness_mineral_waters_under = {
                enabled = core.settings:get_bool('everness_mineral_waters_under', true),
                y_max = tonumber(core.settings:get('everness_mineral_waters_under_y_max')) or 0,
                y_min = tonumber(core.settings:get('everness_mineral_waters_under_y_min')) or -31000,
            },
        },
        features = {
            everness_feature_sneak_pickup = core.settings:get_bool('everness_feature_sneak_pickup', false),
            everness_feature_skybox = core.settings:get_bool('everness_feature_skybox', false),
        }
    },
    hammer_cid_data = {},
    colors = {
